...
\item Highly effective in implementing and fine-tuning team processes and maintaining high efficiency.
\item Experience building AI-native products and experiences. 
...
\begin{rSubsection}{Underflow}{December 2025 -- Present}{CTO}{San Francisco, CA}
\item Built AI agents for automating email-based workflows in the insurance industry.
\item Became a licensed California insurance broker agent.
\end{rSubsection}

%------------------------------------------------

\begin{rSubsection}{Instacart}{April 2025 -- December 2025}{Senior Engineering Manager}{San Francisco, CA}
\item Led a team of 20 engineers supporting the Fulfillment Services business, unlocking an additional \$300M+ in iGTV.
\item Managed relationships with partner tech teams to collaborate on fulfillment integrations.
\item Participated extensively in the recruitment process, 15+ engineers personally.
\item Promoted team adoption of AI coding tools and best practices.
\end{rSubsection}
